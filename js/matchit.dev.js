...
matchit_components_categories_CategoriesView.prototype = $extend(matchit_core_components_ComponentView.prototype,{
	...
	,createCategories: function() {
		...
		this._categoriesContainer.addChild(this._education);
		...
		this._landscapes = new PIXI.Sprite(this.loader.getTexture("categories_landscapes"));
		this._categoriesContainer.addChild(this._landscapes);
		this._education.click = this._education.tap = function(evt1) {
		...
		this._categories = [this._christmas,this._emoticons,this._pokeman,this._social,this._education,this._landscapes];
	...
	,_positionCategories: function() {
		...
		while(_g < _g1.length) {
			...
			xpos += category.width + 15;
			if(count % rowMax == 0) {
				xpos = 0;
				ypos += category.width + 15;
			}
		}
	}
	,_resize: function() {
...
matchit_components_tiles_TilesView.prototype = $extend(matchit_core_components_ComponentView.prototype,{
	...
	,_createTile: function(tileId,scale,id) {
		var tile = new matchit_components_tiles_Tile(this.loader.getTexture("tiles_" + this._category + "_" + tileId),this.loader.getTexture("tiles_tile"));
