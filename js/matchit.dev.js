...
matchit_components_categories_CategoriesModel.prototype = $extend(matchit_core_components_ComponentModel.prototype,{
	init: function() {
		...
		this.categoryColors.set("math",13158);
		this.categoryColors.set("space",13158);
		this.categoryColors.set("flowers",13158);
	}
...
matchit_components_categories_CategoriesModel.MATH_COLOR = 13158;
matchit_components_categories_CategoriesModel.SPACE_COLOR = 13158;
matchit_components_categories_CategoriesModel.FLOWERS_COLOR = 13158;
...
matchit_components_categories_CategoriesModel.RANDOM_CATEGORIES = ["social","avatars","education","landscapes","wedding","math","flowers"];
